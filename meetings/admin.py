...
class ParticipantInline(admin.TabularInline):
    ...
    fields = ("email", "name", "user", "status", "invited_at", "responded_at")
...
class MeetingAdmin(admin.ModelAdmin):
    list_display = ("title", "start_time", "end_time", "status", "created_by", "created_at")
    ...
    fieldsets = (
        (None, {"fields": ("id", "title", "description", "location")}),
...
class ParticipantAdmin(admin.ModelAdmin):
    list_display = ("email", "name", "meeting", "status", "invited_at")
    list_filter = ("status",)
...
class MeetingNotificationAdmin(admin.ModelAdmin):
    list_display = ("email", "meeting", "notification_type", "is_sent", "sent_at")
